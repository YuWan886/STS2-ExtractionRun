...
/// <summary>
///     Reads the <c>extractionrun-variants.manifest</c> bundle, validates each variant
...
{
    private const string ManifestName = "extractionrun-variants.manifest";
    private const string CompatTargetMarkerName = "compat-target.txt";
    private const string VariantAssemblyName = "ExtractionRun.Content.dll";
