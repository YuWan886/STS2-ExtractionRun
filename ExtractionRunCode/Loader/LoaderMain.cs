...
namespace ExtractionRun.Loader;

/// <summary>
///     Entry assembly for the multi-version ExtractionRun bundle. It loads the matching
///     <c>ExtractionRun.Content</c> from <c>lib/&lt;compat&gt;/</c> into the default ALC,
...
public static class LoaderMain
{
    ...
    private const string VariantManifestName = "extractionrun-variants.manifest";
    ...
    /// <summary>
    ///     Associates the hand-loaded content-variant assembly with the <c>ExtractionRun</c> mod so the
    ...
    private static void EnsureBridgePatch()
    {
        ...
        var harmony = new Harmony("ExtractionRun.Loader.ReflectionBridge");
